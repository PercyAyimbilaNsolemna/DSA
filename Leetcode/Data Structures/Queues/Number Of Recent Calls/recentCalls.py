...
class RecentCounter(object):
    ...
    def ping(self, t):
        ...
        :rtype: int
        """
        #Adds the request(t) to the end of the requests queue 
        self.requests.append(t)

        #Checks if the queue is not empty and the top is old then it removes it from the queue since it does not
        #Satisfy the condition [t-3000, t]
