'''
    ...
    Follow up: Could you do it without extra space and in O(n) runtime? You may assume the returned list does 
...
class Solution(object):
    def findDisappearedNumbers(self, nums):
        ...
        for num in range(1, len(nums)+1):
            if num not in nums:
                dispearedNumbers.append(num)

        return dispearedNumbers
